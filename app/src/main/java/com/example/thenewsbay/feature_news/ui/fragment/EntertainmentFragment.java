...
//        articleArrayList = new ArrayList<>();
        entertainmentRecyclerView = view.findViewById(R.id.recyclerview_entertainment);
        entertainmentRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
//        newsAdapter = new ArticleAdapter(getContext(), articleArrayList);
        articleAdapter = new ArticleAdapter(getContext());
        entertainmentRecyclerView.setAdapter(articleAdapter);
