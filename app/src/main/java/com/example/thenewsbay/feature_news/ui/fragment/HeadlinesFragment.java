...
public class HeadlinesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        headlinesRecyclerView = view.findViewById(R.id.recyclerview_headlines);
        headlinesRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        headlinesRecyclerView.setHasFixedSize(true);

        articleAdapter = new ArticleAdapter(getContext());
        headlinesRecyclerView.setAdapter(articleAdapter);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mArticleViewModel.getHeadlinesNews(countryCode, pageSize, pageNumber);
